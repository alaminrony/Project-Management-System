...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i>@lang('label.EDIT_PROJECT_STATUS')
            </div>
        </div>
        <div class="portlet-body form">
            {{ Form::open(['route' => array('projectStatus.update', $target->id), 'method' => 'PATCH','class' => 'form-horizontal']) }}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="name">@lang('label.STATUS_NAME') :<span class="text-danger"> *</span></label>
                            <div class="col-md-8">
