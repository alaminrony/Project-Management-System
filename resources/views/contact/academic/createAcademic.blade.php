<div class="modal-content">
    ...
    {{ Form::open(array('role' => 'form', 'url' => '', 'class' => 'form-horizontal form-row-seperated', 'id'=>'createAcademicFormData')) }}
    {{csrf_field()}}
    <div class="modal-body">
        ...
        <div id="showSkillInfo" >
            <div class="form-group">
                ...
                <div class="col-md-6">
                    {!! Form::text('degree_name','',['class'=>'form-control','id'=>'degree_name','tabindex'=>'2']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    {!! Form::text('institute','',['class'=>'form-control','id'=>'institute','tabindex'=>'3']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    {!! Form::text('batch','',['class'=>'form-control','id'=>'batch','tabindex'=>'3']) !!}
                </div>
            </div>
    ...
    <div class=" text-center modal-footer">
        <button type="button" class="btn btn-primary" id="storeAcademic">{{__('label.SAVE')}}</button>
