<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        <h4 class="modal-title">
            <i class="fa fa-pencil-square-o"></i> {{__('label.CREATE_SPECIALTY')}}
        </h4>
    </div>
    {{ Form::open(array('role' => 'form', 'url' => '', 'class' => 'form-horizontal form-row-seperated', 'id'=>'createSpecialtyFormData')) }}
    {{csrf_field()}}
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center vcenter">
                        <div class="md-checkbox has-success">
                            {!! Form::checkbox('speciality[]',$speciality->id,false,['id' =>$speciality->id,'class'=> 'md-check bf-check']) !!}
    ...
    <div class=" text-center modal-footer">
        <button type="button" class="btn btn-primary" id="storeSpecialty">{{__('label.SAVE')}}</button>
