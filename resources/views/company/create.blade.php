...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i>@lang('label.CREATE_COMPANY')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'company/store','class' => 'form-horizontal','files'=>true)) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!!Form::radio('type','1',true,['id'=>'mCompany'])!!}&nbsp;&nbsp;{!!Form::label('mCompany','Mother Company')!!}
