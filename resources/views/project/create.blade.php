...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i>@lang('label.CREATE_PROJECT')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'project/store','class' => 'form-horizontal','files'=>true)) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('client_id',$clientList,null,['id'=> 'client', 'class' => 'form-control js-source-states']) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('project_status',$projectStatusList,null,['id'=> 'project_status', 'class' => 'form-control js-source-states']) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('tentative_date',date('Y-m-d'), ['id'=> 'tentative_date', 'class' => 'form-control','rows'=>2,'cols'=>30]) !!} 
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('dead_line',date('Y-m-d'), ['id'=> 'dead_line', 'class' => 'form-control','rows'=>2,'cols'=>30]) !!} 
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/project'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
