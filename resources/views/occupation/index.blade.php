...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i>@lang('label.OCCUPATION_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[4][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('occupation/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_OCCUPATION')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'occupation/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="9%">
                                <div class="text-center">
                                    ...
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('occupation/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                    ...
                                    <div class="pull-right">
                                        {{ Form::open(array('url' => 'occupation/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_OCCUPATION_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
