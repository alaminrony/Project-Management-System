...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i>@lang('label.TASK_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[77][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('task/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_TASK')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'task/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <tr>
                            ...
                            <td width="10%">
                                <div class="text-center">
                                    @if(!empty($userAccessArr[77][3]))
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('task/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                            <i class="fa fa-edit"></i>
                                        </a> 
                                    </div>
                                    @endif
                                    @if(!empty($userAccessArr[77][4]))
                                    <div>
                                        {{ Form::open(array('url' => 'task/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
