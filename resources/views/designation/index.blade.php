...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i>@lang('label.DESIGNATION_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[3][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('designation/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_DESIGNATION')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'designation/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="9%">
                                <div class="text-center">
                                    @if(!empty($userAccessArr[3][3]))
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('designation/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                    </div>

                                    @endif
                                    @if(!empty($userAccessArr[3][4]))
                                    <div class="pull-right">
                                        {{ Form::open(array('url' => 'designation/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_DESIGNATION_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
