...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i><?php echo app('translator')->get('label.COMPANY_LIST'); ?>
            </div>
            <div class="actions">
                <?php if(!empty($userAccessArr[5][2])): ?>
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('company/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_COMPANY'); ?>
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                <?php echo Form::open(array('group' => 'form', 'url' => 'company/filter','class' => 'form-horizontal')); ?>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="center">
                            ...
                            <th><?php echo app('translator')->get('label.COMPANY_ADDRESS'); ?></th>
                            <th><?php echo app('translator')->get('label.CONTACT_NUMBER'); ?></th>
                            <th><?php echo app('translator')->get('label.EMAIL'); ?></th>
                            <th><?php echo app('translator')->get('label.INDUSTRY'); ?></th>
                            <th><?php echo app('translator')->get('label.LOGO'); ?></th>
                            <th><?php echo app('translator')->get('label.COMPANY_TYPE'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($target->address); ?></td>
                            <td><?php echo e($target->contact_no); ?></td>
                            <td><?php echo e($target->email); ?></td>
                            <td><?php echo e($target->industryName); ?></td>
                            <td>
                                <img src="<?php echo e(asset('public/image/'.$target->logo)); ?>" height="50px;" width="50px;"/>
                            </td>
                            <td><?php echo e($target->type == 1 ? __('label.MOTHER_COMPANY') : __('label.SISTER_CONCERN')); ?></td>
                            ...
                            <td width="8%">
                                <div class="text-center">
                                    <?php if(!empty($userAccessArr[5][3])): ?>
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('company/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                                            <i class="fa fa-edit"></i>
                                        </a> 
                                    </div>
                                    <?php endif; ?>
                                    <?php if(!empty($userAccessArr[5][4])): ?>
                                    <div class="pull-right">
                                        <?php echo e(Form::open(array('url' => 'company/' . $target->id.'/'.Helper::queryPageStr($qpArr)))); ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(!empty($userAccessArr[5][17])): ?>
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-warning tooltips" title="Contact Management" href="<?php echo e(URL::to('company/'.$target->id.'/contact')); ?>">
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="8"><?php echo app('translator')->get('label.NO_COMPANY_FOUND'); ?></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\contactDirectory\resources\views/company/index.blade.php ENDPATH**/ ?>