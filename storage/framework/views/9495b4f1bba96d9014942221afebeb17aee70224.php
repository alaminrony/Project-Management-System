...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i><?php echo app('translator')->get('label.PROJECT_STATUS_LIST'); ?>
            </div>
            <div class="actions">
                <?php if(!empty($userAccessArr[72][2])): ?>
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('projectStatus/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_PROJECT_STATUS'); ?>
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                <?php echo Form::open(array('group' => 'form', 'url' => 'projectStatus/filter','class' => 'form-horizontal')); ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php echo Form::text('search',Request::get('search'), ['class' => 'form-control tooltips', 'title' => 'Project name', 'placeholder' => 'Project status name', 'list'=>'search', 'autocomplete'=>'off']); ?> 
                                <datalist id="search">
                        ...
                        <tr>
                            ...
                            <td width="7%">
                                <div class="text-center">
                                    <?php if(!empty($userAccessArr[72][3])): ?>
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('projectStatus/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                                            <i class="fa fa-edit"></i>
                                        </a> 
                                    </div>
                                    <?php endif; ?>
                                    <?php if(!empty($userAccessArr[72][4])): ?>
                                    <div class="pull-right">
                                        <?php echo e(Form::open(array('url' => 'projectStatus/' . $target->id.'/'.Helper::queryPageStr($qpArr)))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\contactDirectory\resources\views/projectStatus/index.blade.php ENDPATH**/ ?>