...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i><?php echo app('translator')->get('label.ROLE_LIST'); ?>
            </div>
            <div class="actions">
                <?php if(!empty($userAccessArr[76][2])): ?>
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('projectRole/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_ROLE'); ?>
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                <?php echo Form::open(array('group' => 'form', 'url' => 'projectRole/filter','class' => 'form-horizontal')); ?>
                        ...
                        <tr>
                            ...
                            <td width="7%">
                                <div class="text-center">
                                    <?php if(!empty($userAccessArr[76][3])): ?>
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('projectRole/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                                            <i class="fa fa-edit"></i>
                                        </a> 
                                    </div>
                                    <?php endif; ?>
                                    <?php if(!empty($userAccessArr[76][4])): ?>
                                    <div class="pull-right">
                                        <?php echo e(Form::open(array('url' => 'projectRole/' . $target->id.'/'.Helper::queryPageStr($qpArr)))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\contactDirectory\resources\views/projectRole/index.blade.php ENDPATH**/ ?>