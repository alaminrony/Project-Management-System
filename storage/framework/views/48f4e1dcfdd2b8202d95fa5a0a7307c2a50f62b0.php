...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i><?php echo app('translator')->get('label.PROJECT_LIST'); ?>
            </div>
            <div class="actions">
                <?php if(!empty($userAccessArr[75][2])): ?>
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('project/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo app('translator')->get('label.CREATE_NEW_PROJECT'); ?>
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                <?php echo Form::open(array('group' => 'form', 'url' => 'project/filter','class' => 'form-horizontal')); ?>
                        ...
                        <tr>
                            ...
                            <td width="9%">
                                <div class="text-center">
                                    <a class="btn btn-xs btn-success tooltips" title="Gantt Chart" href="<?php echo e(URL::to('project/' . $target->id . '/ganttChart'.Helper::queryPageStr($qpArr))); ?>">
                                        <i class="fa fa-line-chart"></i>
                                    </a>
                                    <?php if(!empty($userAccessArr[75][3])): ?>
                                    <div class="pull-left">
                                        <a class="btn btn-xs btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('project/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                    </div>
                                    <?php endif; ?>
                                    <?php if(!empty($userAccessArr[75][4])): ?>
                                    <div class="pull-right">
                                        <?php echo e(Form::open(array('url' => 'project/' . $target->id.'/'.Helper::queryPageStr($qpArr)))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\contactDirectory\resources\views/project/index.blade.php ENDPATH**/ ?>