...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bookmark-o"></i><?php echo app('translator')->get('label.DEPARTMENT_LIST'); ?>
            </div>
            <div class="actions">
                <?php if(!empty($userAccessArr[2][2])): ?>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr class="center">
                            ...
                            <th><?php echo app('translator')->get('label.DESCRIPTION'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($target->description); ?></td>
                            ...
                            <td width="7%">
                                <div class="text-center">
                                    <?php if(!empty($userAccessArr[2][3])): ?>
                                    <div class="pull-left">
                                    ...
                                    <?php endif; ?>
                                    <?php if(!empty($userAccessArr[2][4])): ?>
                                    <div class="pull-right">
                                        <?php echo e(Form::open(array('url' => 'department/' . $target->id.'/'.Helper::queryPageStr($qpArr)))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\contactDirectory\resources\views/department/index.blade.php ENDPATH**/ ?>